 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.modelling.pls.model.impl.ProductionLineModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductionLineModelImpl extends MinimalEObjectImpl.Container implements ProductionLineModel {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.PRODUCTION_LINE_MODEL;
	}
	...
	public EList<NamedElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<NamedElement>(NamedElement.class, this,
					ModelPackage.PRODUCTION_LINE_MODEL__ELEMENTS);
		}
		return elements;
	}
