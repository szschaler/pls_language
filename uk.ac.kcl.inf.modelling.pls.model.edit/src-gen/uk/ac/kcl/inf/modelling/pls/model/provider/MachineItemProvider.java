...
/**
 * This is the item provider adapter for a {@link uk.ac.kcl.inf.modelling.pls.model.Machine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MachineItemProvider extends NamedElementItemProvider {
	/**
	...
	protected void addOutPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Machine_out_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Machine_out_feature", "_UI_Machine_type"),
						ModelPackage.Literals.MACHINE__OUT, true, false, true, null, null, null));
	}
	...
	protected void addInPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Machine_in_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Machine_in_feature", "_UI_Machine_type"),
						ModelPackage.Literals.MACHINE__IN, true, false, true, null, null, null));
	}
