...
/**
 * This is the item provider adapter for a {@link uk.ac.kcl.inf.modelling.pls.model.Conveyor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConveyorItemProvider extends ContainerItemProvider {
	/**
	...
	protected void addTrayPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Conveyor_tray_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Conveyor_tray_feature",
								"_UI_Conveyor_type"),
						ModelPackage.Literals.CONVEYOR__TRAY, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Conveyor_type")
